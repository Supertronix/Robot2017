...
public class OI {
 ...
 // DRIVER CONTROLS
    ...
    public double getLeftDriveY() {
        return RobotMap.INVERSION_CONDUITE_X_DROITE ? -mMainDriveStick.getRawAxis(RobotMap.CONDUITE_Y_GAUCHE): mMainDriveStick.getRawAxis(RobotMap.CONDUITE_Y_GAUCHE);
    }
